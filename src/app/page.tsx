      ...
      <main className="flex min-h-screen max-w-11/12 min-w-5xl flex-col items-center justify-between py-16 px-16 bg-tertiary-blue rounded-b-3xl border-2 border-t-0 border-blue-950">
        ...
        <Container>
          <div className="flex flex-row justixfy-center">
            ...
            <img
              className=": size-31 drop-shadow-lg drop-shadow-neutral-900 sm:size-62"
              src={Img.src}
              alt="Foto de Perfil"
            />
          </div>
        ...
        <Container>
          <div className="flex flex-col gap-5">
            ...
            <Card>
              ...
              código. Você utiliza para evitar erros e melhorar a manutenção dos
              projetos.
            </Card>
            <Card>
              TailwindCSS Framework utilitário que acelera o desenvolvimento de
              interfaces modernas e responsivas. Você sabe aplicar classes para
        ...
        <Container>
          <div className="flex flex-col gap-5">
            ...
            <Card>
              JavaFX Biblioteca para interfaces gráficas em Java. Você tem
              noções iniciais e pode criar aplicações desktop simples.
            </Card>
            <Card>
